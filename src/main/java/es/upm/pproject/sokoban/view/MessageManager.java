...
public class MessageManager {
	...
	private static final String ICONFAIL = "/icon_fail.png";
	
	
	public MessageManager(GameView view) {
		this.view = view;
	}
	...
	public void showControlsAndRules() {
		...
		JOptionPane.showMessageDialog(view, rules, SOKOBAN , 1, new ImageIcon(view.getImagesPath()+"/icon_help.png"));
	}
	...
	public void showYouWonMessage(int gameScore) {
		JOptionPane.showMessageDialog(view,"WINNER!\nYou completed the game!\nGAME SCORE: "+ gameScore, SOKOBAN, 1, new ImageIcon(view.getImagesPath()+"/icon_winner.png"));
	}
	
	public void showSuccessfulSaveMessage() {
		JOptionPane.showMessageDialog(view, "Game saved successfully.", SOKOBAN, 1, new ImageIcon(view.getImagesPath()+"/icon_ok.png"));
	}
	
	public Object showSaveNameInputMessage() {
		return JOptionPane.showInputDialog(view, "Introduce a name for your saved game.",SOKOBAN, 1, new ImageIcon(view.getImagesPath()+"/icon_save.png"), null, null);
	}

	public void showInvalidLevelMessage() {
		JOptionPane.showMessageDialog(view, "The map is not valid. Loading next level.", SOKOBAN, 0, new ImageIcon(view.getImagesPath()+ICONFAIL));
	}

	public void showFailedSaveMessage() {
		JOptionPane.showMessageDialog(view, "There was a problem trying to save the game.", SOKOBAN, 0, new ImageIcon(view.getImagesPath()+ICONFAIL));
	}
	
	public void showFailedLoadMessage() {
		JOptionPane.showMessageDialog(view, "There was a problem trying to load the game.", SOKOBAN, 0, new ImageIcon(view.getImagesPath()+ICONFAIL));
	}

	public int showExitMessage() {
		return JOptionPane.showConfirmDialog(view, "Are you sure you want to leave?\n"
				+ "You may lose your progress.", SOKOBAN, JOptionPane.YES_NO_OPTION, 0, new ImageIcon(view.getImagesPath()+"/icon_q2.png"));
	}
